...
**Styling parity requirement:**
- For visual-match requests, debug and inspect in `http://localhost:3000`
- Compare with the source site for visual output only (not source DOM parity)
- Match layout behavior first, then typography/detail refinements
